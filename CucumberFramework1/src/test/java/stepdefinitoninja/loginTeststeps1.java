...
public class loginTeststeps1 {
	WebDriver driver;
	@Given("open the url of the ninja tutorial")
	...
	driver.findElement(By.id("input-email")).sendKeys("sagar.tatarao@gmail.com");
	driver.findElement(By.id("input-password")).sendKeys("Sagar@458");
	}
